export default {
  ...
  usage: {
    ...
    interceptStatsTitle: '请求拦截统计',
    interceptStatsDescription: '查看当前时间范围内的匹配情况。匹配比例越高，通常说明该模型在当前思考强度下更容易出现降智或异常输出，建议优先切换思考强度，或直接更换模型。',
    externalRadarTitle: '外部雷达参考',
    externalRadarDescription: '下方同步展示 Codex Radar 的降智雷达图，便于将你当前账号的匹配情况与公开观测结果交叉对照。',
    externalRadarStaticHint: '外部公开观测',
    externalRadarOpenSource: '打开 Codex Radar',
    externalRadarLoadFailed: 'Codex Radar 加载失败',
    requestCount: '请求次数',
    matchCount: '匹配次数',
    matchRatio: '匹配比例',
    interceptCount: '拦截次数',
    ...
    guardEnabled: '已开启拦截',
    guardDisabled: '仅记录匹配',
    guardStatusCode: '拦截状态码',
    guardRules: '当前模型规则',
    guardRulesEmpty: '当前未配置模型规则',
    currentView: '当前视角',
    overallView: '整体视角',
    selectionScoped: '当前选中组合',
    modelBreakdown: '模型分布',
    modelEffortBreakdown: '模型 × 推理强度',
    modelEffortBreakdownHint: '点击任意组合即可切换趋势图与概览卡到该组合视角。',
    reasoningEffortBreakdown: '推理强度分布',
    periodToday: '今日',
    period3d: '3 天',
    period7d: '7 天',
    period30d: '30 天',
    ...
    tabs: { usage: '用量明细', conversations: '会话记录', errors: '错误请求' },
    errors: {
  ...
  admin: {
    ...
    usage: {
      ...
      ipAddress: 'IP',
      conversation: '会话',
      conversationTitle: 'OpenAI 会话文本',
      conversationEmpty: '当前请求暂无保留的会话文本',
      failedToLoadConversation: '加载会话文本失败',
      sessionId: '会话 ID',
      turnCount: '轮次数',
      turnLabel: '第 {index} 轮',
      userInput: '用户输入',
      assistantOutput: '助手输出',
      conversationListEmpty: '当前筛选范围内暂无保留的会话记录',
      failedToLoadConversationList: '加载会话记录失败',
      lastTurnPreview: '最近一轮预览',
      openaiReasoningGuardModelEffortTitle: '模型推理强度分布',
      openaiReasoningGuardModelEffortDescription:
        '按当前时间范围、粒度与筛选条件统计 OpenAI 请求的模型与推理强度匹配情况。',
    ...
    ops: {
      ...
      settings: {
        ...
        openaiConversationRetentionEnabled: '启用 OpenAI 会话文本保留',
        openaiConversationRetentionHint: '仅保留原生 OpenAI 对话请求的逐轮 user / assistant 文本，按 session + turn 展示，不保留 system、tool、推理过程。',
        openaiConversationRetentionDays: 'OpenAI 会话文本保留天数',
        aggregation: '预聚合任务',
        ...
        validation: {
          ...
          openaiConversationRetentionRange: 'OpenAI 会话文本保留天数必须在 0-3650 天之间',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexUserAgentRulesHint: '仅作用于 OpenAI 请求。按从上到下顺序匹配客户端原始 User-Agent，大小写不敏感；命中首条规则后，将上游 User-Agent 替换为该行配置的 UA。',
        openaiCodexUserAgentRulesAdd: '添加规则',
        openaiCodexUserAgentRulesRemove: '删除',
        openaiCodexUserAgentRulesKeywordPlaceholder: '关键词（命中客户端 UA）',
        openaiCodexUserAgentRulesUserAgentPlaceholder: '替换后的上游 UA',
      ...
      openaiReasoningGuard: {
        title: 'OpenAI 推理拦截',
        description: '对每个 OpenAI HTTP 请求检查响应中的 reasoning_tokens，命中指定 code 时直接拦截，并计入用户统计。',
        enabled: '是否启用',
        enabledHint: '启用后，命中的响应会被替换为拦截错误，并进入用户拦截统计。',
        modelRules: '按模型规则',
        modelRulesHint: '仅对配置过的模型检查 code；未配置的模型不做匹配。',
        addRule: '添加规则',
        ruleItem: '规则 {index}',
        model: '模型',
        modelPlaceholder: '例如: gpt-5.5',
        codes: '拦截 code',
        codesPlaceholder: '例如: 516, 2048',
        interceptStatusCode: '状态码'
      },
      wechatConnect: {
        title: '微信登录',
