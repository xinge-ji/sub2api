export default {
  ...
  nav: {
    ...
    docs: 'Docs',
    openaiReasoningGuard: 'Intercept Stats',
    myOrders: 'My Orders',
  ...
  usage: {
    ...
    interceptStatsTitle: 'Intercept Stats',
    interceptStatsDescription: 'Review match rates for the selected time range. A higher match ratio usually means the current model is more likely to degrade or produce unstable output at this reasoning effort. Try adjusting reasoning effort or switching models.',
    externalRadarTitle: 'External Radar Reference',
    externalRadarDescription: 'This section mirrors the Codex Radar degradation chart so you can compare your own match patterns with a public observation baseline.',
    externalRadarStaticHint: 'Public external signal',
    externalRadarOpenSource: 'Open Codex Radar',
    externalRadarLoadFailed: 'Failed to load Codex Radar',
    requestCount: 'Request Count',
    matchCount: 'Match Count',
    matchRatio: 'Match Ratio',
    interceptCount: 'Intercept Count',
    interceptRatio: 'Intercept Ratio',
    interceptTrend: 'Match Trend',
    guardStatus: 'Current Status',
    guardEnabled: 'Blocking enabled',
    guardDisabled: 'Match-only mode',
    guardStatusCode: 'Intercept Status Code',
    guardRules: 'Current Model Rules',
    guardRulesEmpty: 'No model rules configured',
    currentView: 'Current View',
    overallView: 'Overall View',
    selectionScoped: 'current selection scope',
    modelBreakdown: 'Model Breakdown',
    modelEffortBreakdown: 'Model × Reasoning Effort',
    modelEffortBreakdownHint: 'Click a combination to scope both the trend chart and summary cards.',
    reasoningEffortBreakdown: 'Reasoning Effort Breakdown',
    periodToday: 'Today',
    period3d: '3 Days',
    period7d: '7 Days',
    period30d: '30 Days',
    ...
    tabs: { usage: 'Usage', conversations: 'Conversations', errors: 'Error Requests' },
    errors: {
  ...
  admin: {
    ...
    usage: {
      ...
      conversationTitle: 'OpenAI Conversation Text',
      conversationEmpty: 'No retained conversation text for this request',
      failedToLoadConversation: 'Failed to load conversation text',
      sessionId: 'Session ID',
      turnCount: 'Turns',
      turnLabel: 'Turn {index}',
      userInput: 'User Input',
      assistantOutput: 'Assistant Output',
      conversationListEmpty: 'No retained conversations for the current filters',
      failedToLoadConversationList: 'Failed to load retained conversations',
      lastTurnPreview: 'Latest Turn Preview',
      openaiReasoningGuardModelEffortTitle: 'Model × Reasoning Effort',
      openaiReasoningGuardModelEffortDescription:
        'OpenAI match distribution by model and reasoning effort for the current time range, granularity, and filters.',
    ...
    ops: {
      ...
      settings: {
        ...
        openaiConversationRetentionEnabled: 'Enable OpenAI conversation text retention',
        openaiConversationRetentionHint: 'Retain only per-turn user / assistant text for native OpenAI conversation requests. Stored as session + turn rows, excluding system prompts, tools, and reasoning traces.',
        ...
        validation: {
          ...
          openaiConversationRetentionRange: 'OpenAI conversation retention days must be between 0 and 3650',
          slaMinPercentRange: 'SLA minimum percentage must be between 0 and 100',
          ttftP99MaxRange: 'TTFT P99 maximum must be a number ≥ 0',
          requestErrorRateMaxRange: 'Request error rate maximum must be between 0 and 100',
          upstreamErrorRateMaxRange: 'Upstream error rate maximum must be between 0 and 100',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexUserAgentRulesHint: 'OpenAI only. Match against the client\'s original User-Agent from top to bottom, case-insensitively; the first matching rule replaces the upstream User-Agent with the UA configured on that row.',
        openaiCodexUserAgentRulesAdd: 'Add rule',
        openaiCodexUserAgentRulesRemove: 'Remove',
        openaiCodexUserAgentRulesKeywordPlaceholder: 'Keyword to match in client UA',
        openaiCodexUserAgentRulesUserAgentPlaceholder: 'Replacement upstream UA',
      ...
      openaiReasoningGuard: {
        title: 'OpenAI Reasoning Guard',
        description: 'Inspect reasoning_tokens on every OpenAI HTTP response, block matched codes, and include them in user stats.',
        enabled: 'Enabled',
        enabledHint: 'When enabled, matched responses are replaced with a blocked error and counted in user interception stats.',
        modelRules: 'Model rules',
        modelRulesHint: 'Only configured models are checked; models without rules are ignored.',
        addRule: 'Add rule',
        ruleItem: 'Rule {index}',
        model: 'Model',
        modelPlaceholder: 'e.g. gpt-5.5',
        codes: 'Intercept codes',
        codesPlaceholder: 'e.g. 516, 2048',
        interceptStatusCode: 'Status code'
      },
      wechatConnect: {
