...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	usageService.SetOpenAIConversationRetentionRepository(openAIConversationRetentionRepository)
	...
	openAIGatewayService.SetOpenAIConversationRetentionRepository(openAIConversationRetentionRepository)
