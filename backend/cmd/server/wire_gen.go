...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIReasoningGuardRepository := repository.NewOpenAIReasoningGuardRepository(db)
	openAIConversationRetentionRepository := repository.NewOpenAIConversationRetentionRepository(db)
	usageService := service.ProvideUsageService(usageLogRepository, userRepository, client, apiKeyAuthCacheInvalidator, settingService, openAIReasoningGuardRepository, openAIConversationRetentionRepository)
	...
	opsCleanupService := service.ProvideOpsCleanupService(opsRepository, openAIConversationRetentionRepository, db, redisClient, configConfig, channelMonitorService, settingRepository, opsService)
