...
func registerUsageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	usage := admin.Group("/usage")
	{
		...
		usage.GET("/openai-reasoning-guard", h.Admin.Usage.OpenAIReasoningGuardStats)
		usage.GET("/conversations", h.Admin.Usage.ListOpenAIConversations)
		usage.GET("/conversations/by-request/:request_id", h.Admin.Usage.GetOpenAIConversationByRequestID)
